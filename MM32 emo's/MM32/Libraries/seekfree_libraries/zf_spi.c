...
{
	afio_init((PIN_enum)(sck_pin &0xff), GPO_AFPP, (GPIOAF_enum)((sck_pin &0xf00)>>8));			// 提取对应IO索引 AF功能编码
	afio_init((PIN_enum)(mosi_pin &0xff), GPO_AFPP, (GPIOAF_enum)((mosi_pin &0xf00)>>8));		// 提取对应IO索引 AF功能编码
	if(SPI_MISO_NULL != miso_pin)
		afio_init((PIN_enum)(miso_pin &0xff), GPI_FL, (GPIOAF_enum)((miso_pin &0xf00)>>8));		// 提取对应IO索引 AF功能编码
	if(SPI_NSS_NULL != cs_pin)
		afio_init((PIN_enum)(cs_pin &0xff), GPO_AFPP, (GPIOAF_enum)((cs_pin &0xf00)>>8));		// 提取对应IO索引 AF功能编码
}
