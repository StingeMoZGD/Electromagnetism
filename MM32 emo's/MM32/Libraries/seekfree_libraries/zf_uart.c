...
{
	afio_init((PIN_enum)(tx_pin &0xff), GPO_AFPP, (GPIOAF_enum)((tx_pin &0xf00)>>8));	// 提取对应IO索引 AF功能编码
	afio_init((PIN_enum)(rx_pin &0xff), GPI_FL, (GPIOAF_enum)((rx_pin &0xf00)>>8));		// 提取对应IO索引 AF功能编码
}
