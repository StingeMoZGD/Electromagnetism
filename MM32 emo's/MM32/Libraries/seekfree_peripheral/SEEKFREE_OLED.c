...
// @note		内部调用 用户无需关心
//-------------------------------------------------------------------------------------------------------------------
static void oled_wr6dat(uint8 data)
{
	uint8 i=6;
...
void oled_init(void)
{
	gpio_init(OLED_SCL_PIN, GPO_PP, GPIO_HIGH);
	gpio_init(OLED_SDA_PIN, GPO_PP, GPIO_LOW);
	gpio_init(OLED_RST_PIN, GPO_PP, GPIO_HIGH);
	gpio_init(OLED_DC_PIN , GPO_PP, GPIO_HIGH);
	gpio_init(OLED_CS_PIN , GPO_PP, GPIO_HIGH);
