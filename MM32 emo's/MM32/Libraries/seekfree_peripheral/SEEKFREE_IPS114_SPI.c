...
void ips114_init(void)
{
	...
	gpio_init(IPS114_CS_PIN, GPO_PP, GPIO_HIGH);
	gpio_init(IPS114_DC_PIN, GPO_PP, GPIO_LOW);
	gpio_init(IPS114_REST_PIN, GPO_PP, GPIO_LOW);
	gpio_init(IPS114_BL_PIN, GPO_PP, GPIO_HIGH);
